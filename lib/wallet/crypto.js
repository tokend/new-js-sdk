...
exports.encryptSecretSeed = encryptSecretSeed;
exports.decryptSecretSeed = decryptSecretSeed;
...
function encryptSecretSeed(seed, key) {
  var sesionKey = deriveSessionKey(key);
  return encryptData(seed, sesionKey);
}

function decryptSecretSeed(seed, key) {
  var sesionKey = deriveSessionKey(key);
