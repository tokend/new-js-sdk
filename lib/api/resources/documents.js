...
function (_ResourceGroupBase) {
  ...
  (0, _createClass2.default)(Documents, [{
    ...
    key: "masterCreate",
    value: function () {
      var _masterCreate = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      _regenerator.default.mark(function _callee2(documentType, mimeType) {
        var response, url, formData;
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this._server._makeCallBuilder().appendUrlSegment('documents').withSignature().post({
                  data: {
                    type: documentType,
                    attributes: {
                      contentType: mimeType
      ...
      function masterCreate(_x3, _x4) {
        return _masterCreate.apply(this, arguments);
      }
    ...
    value: function _makeCallBuilder() {
      return this._server._makeCallBuilder().appendUrlSegment('accounts').appendAccountId().appendUrlSegment('documents').withSignature();
    }
  }, {
    key: "types",
