  ...
  (0, _createClass2.default)(Wallets, [{
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee2(email, password, recoveryKeypair) {
        var kdfResponse, kdfParams, mainWallet, encryptedMainWallet, secondFactorWallet, encryptedSecondFactorWallet, encryptedRecoveryWallet, response;
    ...
    value: function () {
      ...
      function _getAccountIdByRecoveryId(_x12) {
