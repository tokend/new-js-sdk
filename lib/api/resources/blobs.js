...
var typesToFalgs = (0, _freeze.default)((_Object$freeze2 = {}, (0, _defineProperty2.default)(_Object$freeze2, types.assetDescription, 1), (0, _defineProperty2.default)(_Object$freeze2, types.fundOverview, 2), (0, _defineProperty2.default)(_Object$freeze2, types.fundUpdate, 4), (0, _defineProperty2.default)(_Object$freeze2, types.navUpdate, 8), (0, _defineProperty2.default)(_Object$freeze2, types.bravo, 64), _Object$freeze2));
/**
 * Blobs.
 */
...
function (_ResourceGroupBase) {
  ...
  (0, _createClass2.default)(Blobs, [{
    ...
    value: function _makeCallBuilder(accountId) {
      return this._server._makeCallBuilder().appendUrlSegment('accounts').appendAccountId(accountId).appendUrlSegment('blobs').withSignature();
    }
  }, {
    key: "types",
