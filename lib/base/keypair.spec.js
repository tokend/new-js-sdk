...
describe('Keypair', function () {
  describe('.fromSecret', function () {
    it('creates a keypair correctly', function () {
      var secret = 'SD7X7LEHBNMUIKQGKPARG5TDJNBHKC346OUARHGZL5ITC6IJPXHILY36';

      var kp = _keypair.Keypair.fromSecret(secret);

      expect(kp).to.be.instanceof(_keypair.Keypair);
    ...
    it("throw an error if the arg isn't strkey encoded as a seed", function () {
      expect(function () {
        return _keypair.Keypair.fromSecret('hel0');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromSecret('SBWUBZ3SIPLLF5CCXLWUB2Z6UBTYAW34KVXOLRQ5HDAZG4ZY7MHNBWJ1');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromSecret('masterpassphrasemasterpassphrase');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromSecret('gsYRSEQhTffqA9opPepAENCr2WG6z5iBHHubxxbRzWaHf8FBWcu');
      }).to.throw();
    });
  });
  describe('.fromBase58Seed', function () {
    it('creates a keypair correctly', function () {
      var keys = [{
      ...
      for (var i in keys) {
        ...
        var keyPair = _keypair.Keypair.fromBase58Seed(key.oldSeed);
    ...
    it("throw an error if the arg isn't base58 encoded as a seed", function () {
      expect(function () {
        return _keypair.Keypair.fromBase58Seed('hel0');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromBase58Seed('masterpassphrasemasterpassphrase');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromBase58Seed('gsYRSEQhTffqA9opPepAENCr2WG6z5iBHHubxxbRzWaHf8FBWcu');
      }).to.throw();
    });
  });
  describe('.fromRawSeed', function () {
    it('creates a keypair correctly', function () {
      var seed = 'masterpassphrasemasterpassphrase';

      var kp = _keypair.Keypair.fromRawSeed(seed);
    ...
    it("throws an error if the arg isn't 32 bytes", function () {
      expect(function () {
        return _keypair.Keypair.fromRawSeed('masterpassphrasemasterpassphras');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromRawSeed('masterpassphrasemasterpassphrase1');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromRawSeed(null);
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromRawSeed();
      }).to.throw();
    });
  });
  describe('.fromAccountId', function () {
    it('creates a keypair correctly', function () {
      var kp = _keypair.Keypair.fromAccountId('GAXDYNIBA5E4DXR5TJN522RRYESFQ5UNUXHIPTFGVLLD5O5K552DF5ZH');
    ...
    it("throw an error if the arg isn't strkey encoded as a accountid", function () {
      expect(function () {
        return _keypair.Keypair.fromAccountId('hel0');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromAccountId('masterpassphrasemasterpassphrase');
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromAccountId('sfyjodTxbwLtRToZvi6yQ1KnpZriwTJ7n6nrASFR6goRviCU3Ff');
      }).to.throw();
    });
    it("throws an error if the address isn't 32 bytes", function () {
      ...
      expect(function () {
        return _keypair.Keypair.fromAccountId(null);
      }).to.throw();
      expect(function () {
        return _keypair.Keypair.fromAccountId();
      }).to.throw();
    });
  });
  describe('.random', function () {
    it('creates a keypair correctly', function () {
      var kp = _keypair.Keypair.random();
  ...
  describe('.isValidSecretKey', function () {
    ...
    it('returns false for invalid secret key', function () {
      ...
      for (var i in keys) {
        expect(_keypair.Keypair.isValidSecretKey(keys[i])).to.be.false;
      }
    });
  });
});