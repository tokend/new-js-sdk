...
var _create_change_role_request_builder = require("./create_change_role_request_builder");
...
describe('KYC request op', function () {
  it('Success', function () {
    ...
    var op = _create_change_role_request_builder.CreateChangeRoleRequestBuilder.createChangeRoleRequest({
      requestID: requestID,
    ...
    expect((0, _lodash.isEqual)(obj.creatorDetails, kycData)).to.be.true;
