...
function () {
  ...
  (0, _createClass2.default)(BaseOperation, null, [{
    ...
    value: function isValidAsset(value) {
      return (0, _isString.default)(value) && /^[a-z\d]{1,16}$/i.test(value);
    }
  }, {
    key: "isValidString",
    ...
    value: function isValidAmount(value) {
      ...
      var maxDecimalPlaces = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : MAX_DECIMAL_PLACES;

      if (maxDecimalPlaces > MAX_DECIMAL_PLACES) {
        throw new Error("maxDecimalPlaces cannot exceed ".concat(MAX_DECIMAL_PLACES));
      }
    ...
    key: "_numberFromXDR",
    value: function _numberFromXDR(value) {
    ...
    value: function _statsOpTypeFromNumber(rawStatsOpType) {
      if (!BaseOperation._isValidStatsOpType(rawStatsOpType)) {
        throw new Error("XDR Read Error: Unknown StatsOpType member for value ".concat(rawStatsOpType));
      }

      return _xdr_generated.default.StatsOpType._byValue.get(rawStatsOpType);
    }
  }, {
    key: "_keyValueTypeFromNumber",
    value: function _keyValueTypeFromNumber(rawKVType) {
      if (!BaseOperation._isValidKVType(rawKVType)) {
        throw new Error("XDR Read Error: Unknown KeyValueType number for value ".concat(rawKVType));
      }

      return _xdr_generated.default.KeyValueEntryType._byValue.get(rawKVType);
    }
  }, {
    ...
    value: function _keyValueActionFromNumber(rawKVAction) {
      if (!BaseOperation._isValidKVAction(rawKVAction)) {
        throw new Error("XDR Read Error: Unknown KeyValueAction number for value ".concat(rawKVAction));
      }

      return _xdr_generated.default.ManageKvAction._byValue.get(rawKVAction);
    }
  }, {
    key: "isFeeValid",
    ...
    value: function _isValidStatsOpType(rawStatsOpType) {
      return _xdr_generated.default.StatsOpType._byValue.has(rawStatsOpType);
    }
  }, {
    key: "_isValidKVType",
    value: function _isValidKVType(rawKVType) {
      return _xdr_generated.default.KeyValueEntryType._byValue.has(rawKVType);
    }
  }, {
    key: "_isValidKVAction",
    value: function _isValidKVAction(rawKVAction) {
      return _xdr_generated.default.ManageKvAction._byValue.has(rawKVAction);
    }
  }, {
