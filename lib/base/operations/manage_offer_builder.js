...
function () {
  ...
  (0, _createClass2.default)(ManageOfferBuilder, null, [{
    ...
    value: function manageOffer(opts) {
      var manageOfferOp = ManageOfferBuilder.prepareManageOfferOp(opts);
      var opAttributes = {};
    ...
    key: "prepareManageOfferOp",
    value: function prepareManageOfferOp(opts) {
      var attributes = {
      ...
      return new _xdr_generated.default.ManageOfferOp(attributes);
    }
    /**
