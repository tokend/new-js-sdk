  ...
  (0, _createClass2.default)(ReviewRequestBuilder, null, [{
    ...
    value: function _prepareAttrs(opts) {
      ...
      attrs.reviewDetails = new _xdr_generated.default.ReviewDetails({
        ...
        externalDetails: (0, _isString.default)(opts.reviewDetails.externalDetails) ? opts.reviewDetails.externalDetails : (0, _stringify.default)(opts.reviewDetails.externalDetails),
    ...
    value: function reviewWithdrawRequest(opts) {
      ...
      attrs.requestDetails = new _xdr_generated.default.ReviewRequestOpRequestDetails.createWithdraw(new _xdr_generated.default.WithdrawalDetails({
    ...
    value: function reviewAmlAlertRequest(opts) {
      ...
      attrs.requestDetails = new _xdr_generated.default.ReviewRequestOpRequestDetails.createAmlAlert(new _xdr_generated.default.AmlAlertDetails({
    ...
    value: function reviewLimitsUpdateRequest(opts) {
      ...
      if (!(0, _isUndefined.default)(opts.newLimits.accountID) && !(0, _isUndefined.default)(opts.newLimits.accountRole)) {
        throw new Error('opts.newLimits.accountID and opts.newLimits.accountRole cannot be set for same limits');
      }
      ...
      if (!(0, _isUndefined.default)(opts.newLimits.accountRole)) {
        rawLimitsV2Entry.accountRole = _base_operation.BaseOperation._accountTypeFromNumber(opts.newLimits.accountRole);
      }
      ...
      attrs.requestDetails = new _xdr_generated.default.ReviewRequestOpRequestDetails.updateLimit(new _xdr_generated.default.LimitsUpdateDetails({
    ...
    value: function reviewInvoiceRequest(opts) {
      ...
      var billPayDetails = _payment_builder.PaymentBuilder.prepareAttrs(opts.billPayDetails);
    ...
    value: function reviewRequestToObject(result, attrs) {
      ...
      switch (attrs.requestDetails().switch()) {
        case _xdr_generated.default.ReviewableRequestType.createWithdraw():
          {
            result.withdrawal = {
        ...
        case _xdr_generated.default.ReviewableRequestType.updateLimit():
          {
            ...
            if (newLimitsV2.accountRole()) {
              result.limitsUpdate.newLimits.accountRole = newLimitsV2.accountRole().value;
            }

            break;
          }

        case _xdr_generated.default.ReviewableRequestType.createAmlAlert():
          {
            result.amlAlert = {
