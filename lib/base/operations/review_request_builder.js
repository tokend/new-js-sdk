...
function () {
  ...
  (0, _createClass2.default)(ReviewRequestBuilder, null, [{
    ...
    value: function _prepareAttrs(opts) {
      ...
      if ((0, _isUndefined.default)(opts.tasksToAdd)) {
        opts.tasksToAdd = 0;
      }

      if ((0, _isUndefined.default)(opts.tasksToRemove)) {
      ...
      var reviewDetails = new _xdr_generated.default.ReviewDetails({
      ...
      attrs.ext = new _xdr_generated.default.ReviewRequestOpExt.addTasksToReviewableRequest(reviewDetails);
      return attrs;
    }
    /**
    ...
    value: function reviewRequestToObject(result, attrs) {
      ...
      switch (attrs.requestDetails().switch()) {
        ...
        case _xdr_generated.default.ReviewableRequestType.invoice():
          {
            var billPayDetails = {};
        ...
        case _xdr_generated.default.ReviewableRequestType.contract():
          {
            result.contract = {
      ...
      switch (attrs.ext().switch()) {
        case _xdr_generated.default.LedgerVersion.addTasksToReviewableRequest():
          {
