...
// Automatically generated on 2019-02-02T16:59:42+00:00
...
var types = XDR.config(function (xdr) {
  ...
  xdr.struct("ChangeRoleRequest", [["destinationAccount", xdr.lookup("AccountId")], ["accountRoleToSet", xdr.lookup("Uint64")], ["kycData", xdr.lookup("Longstring")], ["sequenceNumber", xdr.lookup("Uint32")], ["ext", xdr.lookup("ChangeRoleRequestExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("CreateASwapRequestOp", [["request", xdr.lookup("ASwapRequest")], ["ext", xdr.lookup("CreateASwapRequestOpExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("CreateASwapRequestSuccess", [["requestId", xdr.lookup("Uint64")], ["bidOwnerId", xdr.lookup("AccountId")], ["ext", xdr.lookup("CreateASwapRequestSuccessExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("WithdrawalRequest", [["balance", xdr.lookup("BalanceId")], ["amount", xdr.lookup("Uint64")], ["universalAmount", xdr.lookup("Uint64")], ["fee", xdr.lookup("Fee")], ["externalDetails", xdr.lookup("Longstring")], ["ext", xdr.lookup("WithdrawalRequestExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("CancelASwapBidOp", [["bidId", xdr.lookup("Uint64")], ["ext", xdr.lookup("CancelASwapBidOpExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("CancelASwapBidResultSuccess", [["ext", xdr.lookup("CancelASwapBidResultSuccessExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("CreateAccountRoleData", [["details", xdr.lookup("Longstring")], ["accountRuleIDs", xdr.varArray(xdr.lookup("Uint64"), 2147483647)], ["ext", xdr.lookup("CreateAccountRoleDataExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("UpdateAccountRoleData", [["roleId", xdr.lookup("Uint64")], ["details", xdr.lookup("Longstring")], ["accountRuleIDs", xdr.varArray(xdr.lookup("Uint64"), 2147483647)], ["ext", xdr.lookup("UpdateAccountRoleDataExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.union("ManageAccountRoleOpData", {
    ...
    switchName: "action",
    switches: [["create", "createData"], ["update", "updateData"], ["remove", "removeData"]],
    arms: {
  ...
  xdr.union("ManageAccountRoleResult", {
    ...
    switchName: "code",
    switches: [["success", "success"], ["noSuchRule", "ruleId"]],
    arms: {
  ...
  xdr.union("ManageContractRequestOpDetails", {
    ...
    switchName: "action",
    switches: [["create", "createContractRequest"], ["remove", "requestId"]],
    arms: {
  ...
  xdr.union("ManageContractRequestResultSuccessDetails", {
    switchOn: xdr.lookup("ManageContractRequestAction"),
    switchName: "action",
    switches: [["create", "response"], ["remove", xdr.void()]],
    arms: {
  ...
  xdr.struct("UpdateSaleDetailsData", [["requestId", xdr.lookup("Uint64")], ["newDetails", xdr.lookup("Longstring")], ["allTasks", xdr.option(xdr.lookup("Uint32"))], ["ext", xdr.lookup("UpdateSaleDetailsDataExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.union("ManageContractOpData", {
    ...
    switchName: "action",
    switches: [["addDetail", "details"], ["confirmCompleted", xdr.void()], ["startDispute", "disputeReason"], ["resolveDispute", "isRevert"]],
    arms: {
  ...
  xdr.union("ManageContractResponseData", {
    switchOn: xdr.lookup("ManageContractAction"),
    switchName: "action",
    switches: [["confirmCompleted", "isCompleted"]],
    arms: {
  ...
  xdr.union("ManageAssetOpRequest", {
    ...
    switchName: "action",
    switches: [["createAssetCreationRequest", "createAssetCreationRequest"], ["createAssetUpdateRequest", "createAssetUpdateRequest"], ["cancelAssetRequest", "cancelRequest"], ["changePreissuedAssetSigner", "changePreissuedSigner"], ["updateMaxIssuance", "updateMaxIssuance"]],
    arms: {
  ...
  xdr.union("ManageLimitsOpDetails", {
    ...
    switchName: "action",
    switches: [["create", "limitsCreateDetails"], ["remove", "id"]],
    arms: {
  ...
  xdr.union("ManageLimitsResultSuccessDetails", {
    switchOn: xdr.lookup("ManageLimitsAction"),
    switchName: "action",
    switches: [["create", "id"], ["remove", xdr.void()]],
    arms: {
      id: xdr.lookup("Uint64")
    }
  }); // === xdr source ============================================================
  ...
  xdr.struct("SaleCreationRequest", [["saleType", xdr.lookup("Uint64")], ["baseAsset", xdr.lookup("AssetCode")], ["defaultQuoteAsset", xdr.lookup("AssetCode")], ["startTime", xdr.lookup("Uint64")], ["endTime", xdr.lookup("Uint64")], ["softCap", xdr.lookup("Uint64")], ["hardCap", xdr.lookup("Uint64")], ["details", xdr.lookup("Longstring")], ["saleTypeExt", xdr.lookup("SaleTypeExt")], ["requiredBaseAssetForHardCap", xdr.lookup("Uint64")], ["sequenceNumber", xdr.lookup("Uint32")], ["quoteAssets", xdr.varArray(xdr.lookup("SaleCreationRequestQuoteAsset"), 100)], ["ext", xdr.lookup("SaleCreationRequestExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("AssetCreationRequest", [["code", xdr.lookup("AssetCode")], ["preissuedAssetSigner", xdr.lookup("AccountId")], ["maxIssuanceAmount", xdr.lookup("Uint64")], ["initialPreissuedAmount", xdr.lookup("Uint64")], ["policies", xdr.lookup("Uint32")], ["details", xdr.lookup("Longstring")], ["type", xdr.lookup("Uint64")], ["sequenceNumber", xdr.lookup("Uint32")], ["trailingDigitsCount", xdr.lookup("Uint32")], ["ext", xdr.lookup("AssetCreationRequestExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("AssetUpdateRequest", [["code", xdr.lookup("AssetCode")], ["details", xdr.lookup("Longstring")], ["policies", xdr.lookup("Uint32")], ["sequenceNumber", xdr.lookup("Uint32")], ["ext", xdr.lookup("AssetUpdateRequestExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("LimitsUpdateRequest", [["deprecatedDocumentHash", xdr.lookup("Hash")], ["details", xdr.lookup("Longstring")], ["ext", xdr.lookup("LimitsUpdateRequestExt")]]); // === xdr source ============================================================
  //
  //   enum AssetPolicy
  //   {
  //   	TRANSFERABLE = 1,
  ...
  xdr.struct("AssetEntry", [["code", xdr.lookup("AssetCode")], ["owner", xdr.lookup("AccountId")], ["preissuedAssetSigner", xdr.lookup("AccountId")], ["details", xdr.lookup("Longstring")], ["maxIssuanceAmount", xdr.lookup("Uint64")], ["availableForIssueance", xdr.lookup("Uint64")], ["issued", xdr.lookup("Uint64")], ["pendingIssuance", xdr.lookup("Uint64")], ["policies", xdr.lookup("Uint32")], ["type", xdr.lookup("Uint64")], ["trailingDigitsCount", xdr.lookup("Uint32")], ["ext", xdr.lookup("AssetEntryExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("ASwapRequest", [["bidId", xdr.lookup("Uint64")], ["baseAmount", xdr.lookup("Uint64")], ["quoteAsset", xdr.lookup("AssetCode")], ["ext", xdr.lookup("ASwapRequestExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("ASwapBidQuoteAsset", [["quoteAsset", xdr.lookup("AssetCode")], ["price", xdr.lookup("Uint64")], ["ext", xdr.lookup("ASwapBidQuoteAssetExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("AtomicSwapBidEntry", [["bidId", xdr.lookup("Uint64")], ["ownerId", xdr.lookup("AccountId")], ["baseAsset", xdr.lookup("AssetCode")], ["baseBalance", xdr.lookup("BalanceId")], ["amount", xdr.lookup("Uint64")], ["lockedAmount", xdr.lookup("Uint64")], ["createdAt", xdr.lookup("Uint64")], ["isCancelled", xdr.bool()], ["details", xdr.lookup("Longstring")], ["quoteAssets", xdr.varArray(xdr.lookup("ASwapBidQuoteAsset"), 2147483647)], ["ext", xdr.lookup("AtomicSwapBidEntryExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("CreateChangeRoleRequestOp", [["requestId", xdr.lookup("Uint64")], ["destinationAccount", xdr.lookup("AccountId")], ["accountRoleToSet", xdr.lookup("Uint64")], ["kycData", xdr.lookup("Longstring")], ["allTasks", xdr.option(xdr.lookup("Uint32"))], ["ext", xdr.lookup("CreateChangeRoleRequestOpExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("RequestTypedResourceSale", [["type", xdr.lookup("Uint64")], ["ext", xdr.lookup("EmptyExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("AccountRuleResourceReviewableRequest", [["details", xdr.lookup("RequestTypedResource")], ["ext", xdr.lookup("EmptyExt")]]); // === xdr source ============================================================
  //
  //   struct
  //       {
  ...
  xdr.struct("AccountRuleResourceOffer", [["baseAssetType", xdr.lookup("Uint64")], ["quoteAssetType", xdr.lookup("Uint64")], ["baseAssetCode", xdr.lookup("AssetCode")], ["quoteAssetCode", xdr.lookup("AssetCode")], ["ext", xdr.lookup("EmptyExt")]]); // === xdr source ============================================================
  //
  //   struct
  //       {
  //           uint64 saleID;
  ...
  xdr.struct("AccountRuleResourceAtomicSwapBid", [["assetType", xdr.lookup("Uint64")], ["assetCode", xdr.lookup("AssetCode")], ["ext", xdr.lookup("EmptyExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.union("AccountRuleResource", {
    switchOn: xdr.lookup("LedgerEntryType"),
    switchName: "type",
    switches: [["transaction", xdr.void()], ["asset", "asset"], ["reviewableRequest", "reviewableRequest"], ["any", xdr.void()], ["offerEntry", "offer"], ["sale", "sale"], ["atomicSwapBid", "atomicSwapBid"]],
    arms: {
  ...
  xdr.struct("AccountRuleEntry", [["id", xdr.lookup("Uint64")], ["resource", xdr.lookup("AccountRuleResource")], ["action", xdr.lookup("String256")], ["isForbid", xdr.bool()], ["details", xdr.lookup("Longstring")], ["ext", xdr.lookup("AccountRuleEntryExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("UpdateSaleDetailsRequest", [["saleId", xdr.lookup("Uint64")], ["newDetails", xdr.lookup("Longstring")], ["sequenceNumber", xdr.lookup("Uint32")], ["ext", xdr.lookup("UpdateSaleDetailsRequestExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.union("ReviewableRequestEntryBody", {
    switchOn: xdr.lookup("ReviewableRequestType"),
    switchName: "type",
    switches: [["assetCreate", "assetCreationRequest"], ["assetUpdate", "assetUpdateRequest"], ["preIssuanceCreate", "preIssuanceRequest"], ["issuanceCreate", "issuanceRequest"], ["withdraw", "withdrawalRequest"], ["sale", "saleCreationRequest"], ["limitsUpdate", "limitsUpdateRequest"], ["amlAlert", "amlAlertRequest"], ["changeRole", "changeRoleRequest"], ["updateSaleDetail", "updateSaleDetailsRequest"], ["invoice", "invoiceRequest"], ["contract", "contractRequest"], ["createAtomicSwapBid", "aSwapBidCreationRequest"], ["atomicSwap", "aSwapRequest"]],
    arms: {
  ...
  xdr.struct("CreateAccountOp", [["destination", xdr.lookup("AccountId")], ["recoveryKey", xdr.lookup("AccountId")], ["referrer", xdr.option(xdr.lookup("AccountId"))], ["accountType", xdr.lookup("AccountType")], ["policies", xdr.lookup("Uint32")], ["roleId", xdr.lookup("Uint64")], ["ext", xdr.lookup("CreateAccountOpExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("CreateAccountSuccess", [["ext", xdr.lookup("CreateAccountSuccessExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.union("ManageInvoiceRequestOpDetails", {
    ...
    switchName: "action",
    switches: [["create", "invoiceRequest"], ["remove", "requestId"]],
    arms: {
  ...
  xdr.struct("CreateAccountRuleData", [["resource", xdr.lookup("AccountRuleResource")], ["action", xdr.lookup("String256")], ["isForbid", xdr.bool()], ["details", xdr.lookup("Longstring")], ["ext", xdr.lookup("CreateAccountRuleDataExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("UpdateAccountRuleData", [["accountRuleId", xdr.lookup("Uint64")], ["resource", xdr.lookup("AccountRuleResource")], ["action", xdr.lookup("String256")], ["isForbid", xdr.bool()], ["details", xdr.lookup("Longstring")], ["ext", xdr.lookup("UpdateAccountRuleDataExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("RemoveAccountRuleData", [["accountRuleId", xdr.lookup("Uint64")], ["ext", xdr.lookup("RemoveAccountRuleDataExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.union("ManageAccountRuleResult", {
    ...
    switchName: "code",
    switches: [["success", "success"], ["ruleIsUsed", "roleIDs"]],
    arms: {
  ...
  xdr.struct("ASwapBidCreationRequest", [["baseBalance", xdr.lookup("BalanceId")], ["amount", xdr.lookup("Uint64")], ["details", xdr.lookup("Longstring")], ["quoteAssets", xdr.varArray(xdr.lookup("ASwapBidQuoteAsset"), 2147483647)], ["ext", xdr.lookup("ASwapBidCreationRequestExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.struct("CreateASwapBidCreationRequestOp", [["request", xdr.lookup("ASwapBidCreationRequest")], ["ext", xdr.lookup("CreateASwapBidCreationRequestOpExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("CreateASwapBidCreationRequestSuccess", [["requestId", xdr.lookup("Uint64")], ["fulfilled", xdr.bool()], ["ext", xdr.lookup("CreateASwapBidCreationRequestSuccessExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.union("LedgerUpgrade", {
    ...
    switchName: "type",
    switches: [["version", "newLedgerVersion"], ["maxTxSetSize", "newMaxTxSetSize"], ["txExpirationPeriod", "newTxExpirationPeriod"]],
    arms: {
  ...
  xdr.struct("LedgerKeyAtomicSwapBid", [["bidId", xdr.lookup("Uint64")], ["ext", xdr.lookup("LedgerKeyAtomicSwapBidExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //           {
  //           case EMPTY_VERSION:
  ...
  xdr.union("SaleTypeExt", {
    ...
    switchName: "saleType",
    switches: [["basicSale", "basicSale"], ["crowdFunding", "crowdFundingSale"], ["fixedPrice", "fixedPriceSale"]],
    arms: {
  ...
  xdr.struct("PaymentFeeDataV2", [["sourceFee", xdr.lookup("Fee")], ["destinationFee", xdr.lookup("Fee")], ["sourcePaysForDest", xdr.bool()], ["ext", xdr.lookup("PaymentFeeDataV2Ext")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("PaymentV2Response", [["destination", xdr.lookup("AccountId")], ["destinationBalanceId", xdr.lookup("BalanceId")], ["asset", xdr.lookup("AssetCode")], ["sourceSentUniversal", xdr.lookup("Uint64")], ["paymentId", xdr.lookup("Uint64")], ["actualSourcePaymentFee", xdr.lookup("Fee")], ["actualDestinationPaymentFee", xdr.lookup("Fee")], ["ext", xdr.lookup("PaymentV2ResponseExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.struct("ASwapBidExtended", [["bidId", xdr.lookup("Uint64")], ["ext", xdr.lookup("ASwapBidExtendedExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.union("ExtendedResultTypeExt", {
    switchOn: xdr.lookup("ReviewableRequestType"),
    switchName: "requestType",
    switches: [["sale", "saleExtended"], ["none", xdr.void()], ["createAtomicSwapBid", "aSwapBidExtended"], ["atomicSwap", "aSwapExtended"]],
    arms: {
  ...
  xdr.union("ReviewRequestOpRequestDetails", {
    switchOn: xdr.lookup("ReviewableRequestType"),
    switchName: "requestType",
    switches: [["withdraw", "withdrawal"], ["limitsUpdate", "limitsUpdate"], ["amlAlert", "amlAlertDetails"], ["invoice", "billPay"], ["contract", "contract"]],
    arms: {
  ...
  xdr.union("KeyValueEntryValue", {
    ...
    switchName: "type",
    switches: [["uint32", "ui32Value"], ["string", "stringValue"], ["uint64", "ui64Value"]],
    arms: {
