...
var types = XDR.config(function (xdr) {
  ...
  xdr.union("OperationBody", {
    ...
    arms: {
      ...
      createReferenceOp: xdr.lookup("CreateReferenceOp")
    }
  }); // === xdr source ============================================================
  //
  //   struct Operation
  ...
  xdr.union("OperationResultTr", {
    ...
    arms: {
      ...
      createReferenceResult: xdr.lookup("CreateReferenceResult")
    }
  }); // === xdr source ============================================================
  //
  ...
  xdr.union("CreateReferenceOpExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()]],
    arms: {}
  ...
  xdr.struct("CreateReferenceOp", [["reference", xdr.lookup("String64")], ["meta", xdr.lookup("Longstring")], ["ext", xdr.lookup("CreateReferenceOpExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.union("CreateReferenceSuccessResultExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()]],
    arms: {}
  ...
  xdr.struct("CreateReferenceSuccessResult", [["ext", xdr.lookup("CreateReferenceSuccessResultExt")]]); // === xdr source ============================================================
  //
  ...
  xdr.union("CreateReferenceResult", {
    switchOn: xdr.lookup("CreateReferenceResultCode"),
    switchName: "code",
    switches: [["success", "success"]],
    arms: {
      success: xdr.lookup("CreateReferenceSuccessResult")
    },
    defaultArm: xdr.void()
  }); // === xdr source ============================================================
  //
  ...
  xdr.union("ExtendedResultTypeExt", {
    ...
    switches: [["sale", "saleExtended"], ["none", xdr.void()]],
    arms: {
