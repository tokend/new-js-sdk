...
var types = XDR.config(function (xdr) {
  ...
  xdr.union("TransactionExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["addTransactionFee", "maxTotalFee"]],
    arms: {
  ...
  xdr.union("TransactionResultExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["addTransactionFee", "transactionFee"]],
    arms: {
  ...
  xdr.union("ManageAccountRoleOpData", {
    ...
    switchName: "action",
    switches: [["create", "createData"], ["remove", "removeData"]],
    arms: {
  ...
  xdr.union("CreateManageLimitsRequestOpExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["allowToUpdateAndRejectLimitsUpdateRequest", "requestId"]],
    arms: {
  ...
  xdr.union("ManageContractRequestOpDetails", {
    ...
    switchName: "action",
    switches: [["create", "contractRequest"], ["remove", "requestId"]],
    arms: {
  ...
  xdr.union("ManageSaleOpData", {
    ...
    switchName: "action",
    switches: [["createUpdateDetailsRequest", "updateSaleDetailsData"], ["cancel", xdr.void()], ["setState", "saleState"], ["createPromotionUpdateRequest", "promotionUpdateData"], ["createUpdateEndTimeRequest", "updateSaleEndTimeData"]],
    arms: {
  ...
  xdr.union("ManageSaleResultSuccessResponse", {
    switchOn: xdr.lookup("ManageSaleAction"),
    switchName: "action",
    switches: [["createUpdateDetailsRequest", "requestId"], ["cancel", xdr.void()], ["setState", xdr.void()], ["createPromotionUpdateRequest", "promotionUpdateRequestId"], ["createUpdateEndTimeRequest", "updateEndTimeRequestId"]],
    arms: {
      requestId: xdr.lookup("Uint64"),
  ...
  xdr.union("ManageSaleResultSuccessExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["allowToUpdateVotingSalesAsPromotion", "fulfilled"]],
    arms: {
      fulfilled: xdr.bool()
    }
  }); // === xdr source ============================================================
  ...
  xdr.union("AccountEntryExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["useKycLevel", "kycLevel"], ["replaceAccountTypesWithPolicy", "accountEntryExt"]],
    arms: {
  ...
  xdr.union("ManageAssetOpRequest", {
    ...
    switchName: "action",
    switches: [["createAssetCreationRequest", "createAsset"], ["createAssetUpdateRequest", "updateAsset"], ["cancelAssetRequest", "cancelRequest"], ["changePreissuedAssetSigner", "changePreissuedSigner"], ["updateMaxIssuance", "updateMaxIssuance"]],
    arms: {
  ...
  xdr.union("ContractEntryExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["addCustomerDetailsToContract", "customerDetails"]],
    arms: {
  ...
  xdr.union("SaleCreationRequestExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["typedSale", "saleTypeExt"], ["allowToSpecifyRequiredBaseAssetAmountForHardCap", "extV2"], ["statableSale", "extV3"]],
    arms: {
  ...
  xdr.union("AssetCreationRequestExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["addAssetBalancePrecision", "trailingDigitsCount"]],
    arms: {
  ...
  xdr.union("LimitsUpdateRequestExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["limitsUpdateRequestDeprecatedDocumentHash", "details"]],
    arms: {
      details: xdr.lookup("Longstring")
    }
  }); // === xdr source ============================================================
  ...
  xdr.enum("AssetPolicy", {
    ...
    canBeBaseInAtomicSwap: 256,
    canBeQuoteInAtomicSwap: 512
  }); // === xdr source ============================================================
  //
  ...
  xdr.union("ReviewableRequestEntryExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["addTasksToReviewableRequest", "tasksExt"]],
    arms: {
  ...
  xdr.union("CreateAccountOpExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["passExternalSysAccIdInCreateAcc", "externalSystemIDs"], ["replaceAccountTypesWithPolicy", "opExt"]],
    arms: {
  ...
  xdr.union("CreateIssuanceRequestOpExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["addTasksToReviewableRequest", "allTasks"]],
    arms: {
  ...
  xdr.union("SaleEntryExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["typedSale", "saleTypeExt"], ["statableSale", "statableSaleExt"]],
    arms: {
      saleTypeExt: xdr.lookup("SaleTypeExt"),
  ...
  xdr.struct("ReviewDetails", [["tasksToAdd", xdr.lookup("Uint32")], ["tasksToRemove", xdr.lookup("Uint32")], ["externalDetails", xdr.lookup("Longstring")], ["ext", xdr.lookup("ReviewDetailsExt")]]); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //       {
  //       case EMPTY_VERSION:
  ...
  xdr.union("ReviewRequestOpRequestDetails", {
    switchOn: xdr.lookup("ReviewableRequestType"),
    switchName: "requestType",
    switches: [["withdraw", "withdrawal"], ["limitsUpdate", "limitsUpdate"], ["twoStepWithdrawal", "twoStepWithdrawal"], ["amlAlert", "amlAlertDetails"], ["updateKyc", "updateKyc"], ["invoice", "billPay"], ["contract", "contract"]],
    arms: {
  ...
  xdr.union("ReviewRequestOpExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["emptyVersion", xdr.void()], ["addTasksToReviewableRequest", "reviewDetails"]],
    arms: {
  ...
  xdr.enum("ReviewRequestResultCode", {
    ...
    baseAssetNotFound: -150,
    baseAssetCannotBeSwapped: -151,
    quoteAssetNotFound: -152,
    quoteAssetCannotBeSwapped: -153,
    assetsAreEqual: -154,
    aswapBidUnderfunded: -160,
    aswapPurchaserFullLine: -161
  }); // === xdr source ============================================================
  //
  //   union switch (LedgerVersion v)
  //   		{
  ...
  xdr.union("ReviewRequestResultSuccessExt", {
    switchOn: xdr.lookup("LedgerVersion"),
    switchName: "v",
    switches: [["addSaleIdReviewRequestResult", "saleId"], ["addReviewInvoiceRequestPaymentResponse", "paymentV2Response"], ["addContractIdReviewRequestResult", "contractId"], ["emptyVersion", xdr.void()], ["addTasksToReviewableRequest", "extendedResult"]],
    arms: {
