...
describe('CSV Parser tests', () => {
  describe('Integration tests', () => {
    it('Upload valid "* .csv" file for the Mass Compulsory Asset Transfer operation', async () => {
      const csv = "Operation type,Asset,Amount,Source,Destination,Creator details\nCompulsory Asset Transfer,BTC,10,GBA4EX43M25UPV4WIE6RRMQOFTWXZZRIPFAI5VPY6Z2ZVVXVWZ6NEOOB,GDAH3TH2AXUHU5EMWIUHTILN33A52OR7U6H7NGCLYJNYEPDZIKHD5WZD,{\"testKey\": \"testValue\"}"
    ...
    it('Upload invalid "* .csv" file for the Mass Compulsory Asset Transfer operation', async () => {
      const csv = "Operation type,Asset,Amount,Source,Destination,Creator details\nCompulsory Asset Transfer,BTC,10,GBA4EX43M25UPV4WIE6RRMQOFTWXZZRIPFAI5VPY6Z2ZVVXVWZ6NEOOB,,{\"testKey\": \"testValue\"}"
    ...
    it('Upload valid "* .csv" file for the Mass Unlock of Unclaimed Assets operation', async () => {
      const csv = "Operation type,Deferred Payment,Asset,Amount,Source,Creator details\nUnlock of Unclaimed Assets,1,UAH,10,GBA4EX43M25UPV4WIE6RRMQOFTWXZZRIPFAI5VPY6Z2ZVVXVWZ6NEOOB,{\"testKey\": \"testValue\"}"
    ...
    it('Upload invalid "* .csv" file for the Mass Unlock of Unclaimed Assets operation', async () => {
      const csv = "Operation type,Deferred Payment,Asset,Amount,Source,Creator details\nUnlock of Unclaimed Assets,1,UAH,,GBA4EX43M25UPV4WIE6RRMQOFTWXZZRIPFAI5VPY6Z2ZVVXVWZ6NEOOB,{\"testKey\": \"testValue\"}"
  ...
  describe('Performance tests', () => {
    it('Upload the "* .csv" file with the data for 1 million transactions for the Mass Compulsory Asset Transfer operation', async () => {
      var csv = "Operation type,Asset,Amount,Source,Destination,Creator details"
    ...
    it('Upload the "* .csv" file with the data for 1 million transactions for the Mass Unlock of Unclaimed Assets operation', async () => {
      var csv = "Operation type,Deferred Payment,Asset,Amount,Source,Creator details"
      for (var i = 0; i < performanceTestsRowsCount; i++) {
        csv = csv + "\nUnlock of Unclaimed Assets,1,UAH,10,GBA4EX43M25UPV4WIE6RRMQOFTWXZZRIPFAI5VPY6Z2ZVVXVWZ6NEOOB,{\"testKey\": \"testValue\"}"
      }
