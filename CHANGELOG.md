...
#### Added
- Mime type for fetching document url in `DocumentsManager`
...
### Fixed
- npm ignore
- `dist, lib` folders including to npm package
...
## [1.14.1] - 2022-08-01
### Added
- `verification_code` param to create a wallet to WalletsManager

## [1.14.0] - 2022-05-24
### Added
- `role` param to create a wallet to WalletsManager
...
[Unreleased]: https://github.com/tokend/new-js-sdk/compare/1.16.0-rc.1...HEAD
[1.16.0-rc.1]: https://github.com/tokend/new-js-sdk/compare/1.16.0-rc.0...1.16.0-rc.1
